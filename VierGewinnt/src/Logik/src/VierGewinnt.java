...
public class VierGewinnt {
	...
	public static boolean gibtEsEinenGewinner(char[][] spielfeld, boolean gewinner) {
		...
		for (int i = 0; i <= 3; i++) {
			for (int n = 0; n < 5; n++) {
				if (spielfeld[5 - n][0 + i] == 'X' && spielfeld[5 - n][1 + i] == 'X' && spielfeld[5 - n][2 + i] == 'X'
						&& spielfeld[5 - n][3 + i] == 'X') {

					gewinner = true;
					return gewinner;
				}
				if (spielfeld[5 - n][0 + i] == 'O' && spielfeld[5 - n][1 + i] == 'O' && spielfeld[5 - n][2 + i] == 'O'
						&& spielfeld[5 - n][3 + i] == 'O') {
		...
		for (int i = 0; i < 2; i++) {
			for (int n = 0; n < 6; n++) {
				if (spielfeld[5 - i][0 + n] == 'X' && spielfeld[4 - i][0 + n] == 'X' && spielfeld[3 - i][0 + n] == 'X'
						&& spielfeld[2 - i][0 + n] == 'X') {
					gewinner = true;
					return gewinner;
				}
				if (spielfeld[5 - i][0 + n] == 'O' && spielfeld[4 - i][0 + n] == 'O' && spielfeld[3 - i][0 + n] == 'O'
						&& spielfeld[2 - i][0 + n] == 'O') {
					gewinner = true;
					return gewinner;
		...
		for (int i = 0; i < 3; i++) {
			for (int n = 0; n < 4; n++) {
				if (spielfeld[5 - i][0 + n] == 'X' && spielfeld[4 - i][1 + n] == 'X' && spielfeld[3 - i][2 + n] == 'X'
						&& spielfeld[2 - i][+3 + n] == 'X') {
					gewinner = true;
					return gewinner;
				}
				if (spielfeld[5 - i][0 + n] == 'O' && spielfeld[4 - i][1 + n] == 'O' && spielfeld[3 - i][2 + n] == 'O'
						&& spielfeld[2 - i][+3 + n] == 'O') {
					gewinner = true;
					return gewinner;
				}
		...
		for (int i = 0; i < 3; i++) {
			for (int n = 0; n <= 2; n++) {
				if (spielfeld[5 - i][6 - n] == 'X' && spielfeld[4 - i][5 - n] == 'X' && spielfeld[3 - i][4 - n] == 'X'
						&& spielfeld[2 - i][3 - n] == 'X') {
					gewinner = true;
					return gewinner;
				}
				if (spielfeld[5 - i][6 - n] == 'O' && spielfeld[4 - i][5 - n] == 'O' && spielfeld[3 - i][4 - n] == 'O'
						&& spielfeld[2 - i][3 - n] == 'O') {
					gewinner = true;
					return gewinner;
				}
